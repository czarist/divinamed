...
if ($response != null && $response->success) {
  ...
  //====================================================
  $email_remetente = ""; // deve ser um email do dominio
  $email_key = "";
  //====================================================
  ...
  //====================================================
  $email_destinatario = "onsaudeipatinga@gmail.com"; // qualquer email pode receber os dados
  $email_reply = $email;
  $email_assunto = "[E9 TELEMEDICINA] CONTATO";
  //====================================================
  ...
  $M->Host = 'smtp.hostinger.com'; # Colocamos o host de envio de e-mail.
  ...
  if ($M->send()) {
    echo '<script type="text/javascript">
            ...
            window.location.href =  "https://e9telemedicina.com.br/#SAIBAMAIS";
            </script>';
  } else {
    echo '<script type="text/javascript">
             alert(\'Falha ao enviar, por favor tente novamente.\');
             window.location.href =  "https://e9telemedicina.com.br/#SAIBAMAIS";   </script>';
  }
} else {
  echo '<script type="text/javascript">
